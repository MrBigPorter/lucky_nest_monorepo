...
import type { BaseSelectProps } from "@ui-kit/ui/components/BaseSelect/type";
...
const selectTriggerVariants = cva(
  "w-full bg-white pl-[10rem] border-gray-300 rounded-[8rem] focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500 focus-visible:ring-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: "!h-[50rem] text-[18rem] py-[2rem] px-[10rem]",
      },
    },
    defaultVariants: {
      variant: "default",
...
const selectContentVariants = cva(
  "max-h-[300rem] min-w-[8rem] pl-[10rem] overflow-y-auto bg-white shadow-lg rounded-md border border-gray-300 focus:outline-none focus:ring-0 focus:ring-blue-500",
  {
    variants: {
      variant: {
        default: "bg-white",
...
const selectItemVariants = cva(
  "relative flex cursor-default select-none items-center rounded-[8rem] py-[1.5rem] pl-[10rem] pr-[8rem] outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
  {
    variants: {
      variant: {
