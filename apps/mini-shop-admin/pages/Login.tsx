        ...
        >
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 text-sm text-center">
              {isRegister ? 'Join LuxeAdmin to manage your empire' : 'Enter your credentials to access the dashboard'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-4">
              <div className="relative group">
                <Mail className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary-500 transition-colors" size={18} />
                <input 
                  type="email" 
              ...
              <div className="relative group">
                <Lock className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary-500 transition-colors" size={18} />
                <input 
                  type="password" 
              ...
              {isRegister && (
                ...
                >
                  <ShieldCheck className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary-500 transition-colors" size={18} />
                  <input 
                    type="password" 
